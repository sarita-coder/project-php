<?php 
	...
	// como el campo del mail esta deshabilitado en el form php no lo reconoce por eso tengo que guardar su valor en un campo oculto
	...
	if($num_regs==1){
		...
		$mensaje = "No se pudieron hacer los cambios en los datos del contacto con el mail <b>$email</b> por que no existe o esta duplicado.";
